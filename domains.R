...
PYA$Sample <- as.integer(substr(PYA$Experiment,7,7))
PYA$Amount <- sapply(codes,compound)
PYA$Session <- sapply(PYA$Experiment,exp_match)
PYA$ImageCode <- paste(PYA$Experiment,PYA$Batch,sep="-")
